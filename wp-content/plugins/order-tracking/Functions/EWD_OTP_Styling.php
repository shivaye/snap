...
function EWD_OTP_Add_Modified_Styles() {
	...
	$StylesString .="h3.ewd-otp-main-title { ";
		...
		if (get_option("EWD_OTP_Styling_Title_Font_Size") != "") {$StylesString .="font-size:" . EWD_OTP_Check_Font_Size(get_option("EWD_OTP_Styling_Title_Font_Size")) . " !important;";} 
	...
	$StylesString .=".ewd-otp-order-label, .ewd-otp-status-label div { ";
		...
		if (get_option("EWD_OTP_Styling_Label_Font_Size") != "") {$StylesString .="font-size:" . EWD_OTP_Check_Font_Size(get_option("EWD_OTP_Styling_Label_Font_Size")) . ";";} 
	...
	$StylesString .=".ewd-otp-order-content div, .ewd-otp-status-label-content div { ";
		...
		if (get_option("EWD_OTP_Styling_Content_Font_Size") != "") {$StylesString .="font-size:" . EWD_OTP_Check_Font_Size(get_option("EWD_OTP_Styling_Content_Font_Size")) . ";";} 
...
function EWD_OTP_Check_Font_Size($Font_Size) {
