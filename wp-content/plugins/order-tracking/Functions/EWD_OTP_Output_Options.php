...
function EWD_OTP_Output_Options() {
	...
	if ($_GET['OTPAction'] == "EWD_OTP_Order_Details" and isset($_GET['Order_ID'])) {include( plugin_dir_path( __FILE__ ) . '../html/OrdersDetails.php');}
	elseif ($_GET['OTPAction'] == "EWD_OTP_Order_Details") {include( plugin_dir_path( __FILE__ ) . '../html/AddOrder.php');}
