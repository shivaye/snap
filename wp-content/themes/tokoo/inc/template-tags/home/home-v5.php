...
if ( ! function_exists( 'tokoo_home_v5_products_4_1_4_block' ) ) {
    function tokoo_home_v5_products_4_1_4_block() {
        ...
        if( tokoo_is_woocommerce_activated() ) {
            ...
            $args = apply_filters( 'tokoo_home_v5_products_4_1_4_block_args', array(
                'animation'         => $animation,
                'shortcode_atts'    => isset( $home_v5['pb2']['shortcode_content'] ) ? tokoo_get_atts_for_shortcode( $home_v5['pb2']['shortcode_content'] ) : array( 'columns' => '2', 'limit' => '9' ),
                'header_args'     => array(
...
if ( ! function_exists( 'tokoo_home_v5_products_carousel_2' ) ) {
    function tokoo_home_v5_products_carousel_2() {
        ...
        if( tokoo_is_woocommerce_activated() ) {
            ...
            $args = array(
                'animation'         => $animation,
                'shortcode_atts'    => isset( $home_v5['pc1']['shortcode_content'] ) ? tokoo_get_atts_for_shortcode( $home_v5['pc1']['shortcode_content'] ) : array( 'columns' => '6', 'limit' => '8' ),
                'header_args'     => array(
...
if ( ! function_exists( 'tokoo_home_v5_products_carousel_1' ) ) {
    function tokoo_home_v5_products_carousel_1() {
        ...
        if( tokoo_is_woocommerce_activated() ) {
            ...
            $args = array(
                'animation'         => $animation,
                'shortcode_atts'    => isset( $home_v5['pc']['shortcode_content'] ) ? tokoo_get_atts_for_shortcode( $home_v5['pc']['shortcode_content'] ) : array( 'columns' => '6', 'limit' => '8' ),
                'header_args'     => array(
...
if ( ! function_exists( 'tokoo_home_v5_banner' ) ) {
    function tokoo_home_v5_banner() {
        ...
        $args = apply_filters( 'tokoo_home_v5_banner_args', array(
            'animation'         => $animation,
            'img_src'       => ( isset( $home_v5['br']['image'] ) && $home_v5['br']['image'] != 0 ) ? wp_get_attachment_url( $home_v5['br']['image'] ) : 'http://placehold.it/1170x301',
    ...
    function tokoo_home_v5_flash_sale_block() {
        ...
        if( tokoo_is_woocommerce_activated() ) {
            ...
            $args = array(
                ...
                'bg_img'            => ( isset( $home_v5['fsc']['bg_img'] ) && $home_v5['fsc']['bg_img'] != 0 ) ? wp_get_attachment_url( $home_v5['fsc']['bg_img'] ) : 'http://placehold.it/1920x915',
                'shortcode_atts'    => isset( $home_v5['fsc']['shortcode_content'] ) ? tokoo_get_atts_for_shortcode( $home_v5['fsc']['shortcode_content'] ) : array( 'columns' => '4', 'per_page' => '24' ),
                'carousel_args'     => array(
...
if ( ! function_exists( 'tokoo_home_v5_products_1_8_block' ) ) {
    function tokoo_home_v5_products_1_8_block() {
        ...
        if( tokoo_is_woocommerce_activated() ) {
            ...
            $args = apply_filters( 'tokoo_home_v5_products_1_8_block_args', array(
                ...
                'shortcode_atts'    => isset( $home_v5['pb1']['shortcode_content'] ) ? tokoo_get_atts_for_shortcode( $home_v5['pb1']['shortcode_content'] ) : array( 'columns' => '4', 'limit' => '9' ),
                'category_args'     => array(
...
if ( ! function_exists( 'tokoo_home_v5_product_categories' ) ) {
    function tokoo_home_v5_product_categories() {
        ...
        $args = apply_filters( 'tokoo_home_v5_product_categories_args', array(
...
if ( ! function_exists( 'tokoo_home_v5_brands_list' ) ) {
    ...
    function tokoo_home_v5_brands_list() {
        ...
        if( tokoo_is_woocommerce_activated() ) {
            ...
            $section_args = apply_filters( 'tokoo_home_v5_brands_list_section_args', array(
                'animation'     => $animation,
                'section_title' => isset( $home_v5['bc']['section_title'] ) ? $home_v5['bc']['section_title'] : esc_html__( 'Our Official Brand', 'tokoo' ),
            ) );

            $taxonomy_args = apply_filters( 'tokoo_home_v5_brands_list_taxonomy_args', array(
            ...
            $carousel_args  = apply_filters( 'tokoo_home_v5_brands_list_carousel_args', array(
                'slidesToShow'  => isset( $home_v5['bc']['slidesToShow'] ) ? $home_v5['bc']['slidesToShow'] : 6,
                'slidesToScroll'=> isset( $home_v5['bc']['slidesToScroll'] ) ? $home_v5['bc']['slidesToScroll'] : 1,
                'autoplay'      => isset( $home_v5['bc']['autoplay'] ) ? filter_var( $home_v5['bc']['autoplay'], FILTER_VALIDATE_BOOLEAN ) : false,
                'responsive'    => array(
                    array(
                        'breakpoint'    => 767,
                        'settings'      => array(
