...
<div class="table-responsive compare">
    ...
    <table class="table table-compare compare-list">
        ...
        <tbody>
            ...
            <tr>
                <th><?php echo esc_html__( 'Product', 'tokoo' ); ?></th>
            ...
            <tr>
                <th><?php echo esc_html__( 'Price', 'tokoo' ); ?></th>
                <?php foreach( $products as $key => $product ) : ?>
                <td>
            ...
            <tr>
                <th><?php echo esc_html__( 'Availability', 'tokoo' ); ?></th>
                <?php foreach( $products as $key => $product ) : ?>
            ...
            <tr>
                <th><?php echo esc_html__( 'Description', 'tokoo' ); ?></th>
                <?php foreach( $products as $key => $product ) : ?>
            ...
            <tr>
                ...
                <td class="text-center">
                    <?php 
                        ...
                        $remove_product_url = esc_url_raw( add_query_arg( $remove_product_url_args, tokoo_get_compare_page_url() ) )
                    ?>
                    <a href="<?php echo esc_url( $remove_product_url ); ?>" data-product_id="<?php echo esc_attr( $product->get_id() ); ?>" class="remove-icon" title="<?php echo esc_attr( esc_html__( 'Remove', 'tokoo' ) ); ?>"><i class="fa fa-times"></i></a>
                </td>
                <?php endforeach ?>
            </tr>
...
<?php else : ?>
    ...
    <div class="compare-empty">
        <h1 class="lead-title text-center cart-empty">
            <?php esc_html_e( 'No products were added to the compare table', 'tokoo' ) ?>
        </h1>
        ...
        <p class="return-to-shop">
            <a class="button" href="<?php echo apply_filters( 'woocommerce_return_to_shop_redirect', get_permalink( wc_get_page_id( 'shop' ) ) ); ?>">
                ...
                <?php esc_html_e( 'Return To Shop', 'tokoo' ) ?>
            </a>
        </p>
    </div>
